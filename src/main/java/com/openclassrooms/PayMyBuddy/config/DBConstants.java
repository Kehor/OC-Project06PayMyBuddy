...
public class DBConstants {
    ...
    public static final String GET_SEND_TRANSACTIONS= "select * from transactions where sender_id = ? order by created_at desc";
    public static final String GET_RECEIVE_TRANSACTIONS= "select * from transactions where receiver_id = ? order by created_at desc";
